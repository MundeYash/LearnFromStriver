...
int main()
{
    ...
    int target = 40;
    cout << "The target element is at index : " << (sortedRotatedSearch_Brute(arr, target) == -1 ? "false" : "true") << endl;
    cout << "The target element is at index : " << (sortedRotatedSearch_Optimised(arr, target) == -1 ? "false" : "true") << endl;
